...
namespace Matisoft.DAL
{
	...
	public partial class Administrator
	{
		...
		public Matisoft.Model.Administrator GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,Admin,Password,AdminiEmail,AdminState,AuthorityID from Administrator ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Matisoft.Model.Administrator model=new Matisoft.Model.Administrator();
		...
		/// 得到一个对象实体
		/// </summary>
		public Matisoft.Model.Administrator DataRowToModel(DataRow row)
		{
			Matisoft.Model.Administrator model=new Matisoft.Model.Administrator();
			if (row != null)
			{
				...
				if(row["AdminiEmail"]!=null)
				{
					model.AdminiEmail=row["AdminiEmail"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,Admin,Password,AdminiEmail,AdminState,AuthorityID ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,Admin,Password,AdminiEmail,AdminState,AuthorityID ");
			strSql.Append(" FROM Administrator ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
