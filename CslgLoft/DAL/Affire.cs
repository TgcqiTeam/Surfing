...
namespace Matisoft.DAL
{
	...
	public partial class Affire
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Affire"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Affire");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Affire ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Matisoft.Model.Affire GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,CustomerEmail,TimeDate,OperationID from Affire ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Matisoft.Model.Affire model=new Matisoft.Model.Affire();
		...
		/// 得到一个对象实体
		/// </summary>
		public Matisoft.Model.Affire DataRowToModel(DataRow row)
		{
			Matisoft.Model.Affire model=new Matisoft.Model.Affire();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,CustomerEmail,TimeDate,OperationID ");
			strSql.Append(" FROM Affire ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,CustomerEmail,TimeDate,OperationID ");
			strSql.Append(" FROM Affire ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Affire T ");
