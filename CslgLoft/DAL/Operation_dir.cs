...
namespace Matisoft.DAL
{
	...
	public partial class Operation_dir
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("OperationID", "Operation_dir"); 
		}
		...
		public bool Exists(int OperationID)
		{
			...
			strSql.Append("select count(1) from Operation_dir");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Operation_dir(");
			strSql.Append("OperationID,Note)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Operation_dir set ");
			...
			parameters[1].Value = model.OperationID;
		...
		public bool Delete(int OperationID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Operation_dir ");
			strSql.Append(" where OperationID=@OperationID ");
			SqlParameter[] parameters = {
					new SqlParameter("@OperationID", SqlDbType.Int,4)			};
			parameters[0].Value = OperationID;
		...
		/// 得到一个对象实体
		/// </summary>
		public Matisoft.Model.Operation_dir GetModel(int OperationID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 OperationID,Note from Operation_dir ");
			strSql.Append(" where OperationID=@OperationID ");
			SqlParameter[] parameters = {
					new SqlParameter("@OperationID", SqlDbType.Int,4)			};
			parameters[0].Value = OperationID;

			Matisoft.Model.Operation_dir model=new Matisoft.Model.Operation_dir();
		...
		/// 得到一个对象实体
		/// </summary>
		public Matisoft.Model.Operation_dir DataRowToModel(DataRow row)
		{
			Matisoft.Model.Operation_dir model=new Matisoft.Model.Operation_dir();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select OperationID,Note ");
			strSql.Append(" FROM Operation_dir ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Operation_dir T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Operation_dir";
